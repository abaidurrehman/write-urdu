// WU-INPUT-001B — testable HTTP boundary for the same-origin translation endpoint.

import {
  INPUT_TRANSLATION_MAX_BODY_BYTES,
  normalizeTranslationRequest
} from './contract.mjs';
import { translateInputText } from './service.mjs';
...
export async function handleLanguageTranslate(request, env) {
