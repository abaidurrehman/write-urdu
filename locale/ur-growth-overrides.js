...
module.exports = {
  '/': [
    ...
    [
      '<article><span class="wu-icon-badge" aria-hidden="true"><i class="fas fa-microphone"></i></span><h3><a href="/tools/urdu-voice-typing">Urdu Voice Typing</a></h3><p>Speak Urdu and turn your voice into editable Urdu text with your microphone.</p></article>',
      '<article><span class="wu-icon-badge" aria-hidden="true"><i class="fas fa-microphone"></i></span><h3><a href="/tools/urdu-voice-typing">اردو وائس ٹائپنگ</a></h3><p>مائیک سے اردو بولیں اور اپنی آواز کو قابلِ تدوین اردو متن میں تبدیل کریں۔</p></article>'
    ]
  ],
