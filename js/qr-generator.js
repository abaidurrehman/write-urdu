(function (window, document) {
    ...
    var staticCopy = {
        en: { reset: 'Reset', back: 'Back to Write Urdu', encodeQuestion: 'What should your QR code open or show?', design: 'Design', qrColour: 'QR colour', background: 'Background', designHelp: 'Use a dark QR colour, a light background and clear space around the code for easier scanning.', recommendedColors: 'Use recommended colors', centreLogo: 'Centre logo', optional: 'optional', chooseLogo: 'Choose a PNG, JPG or WebP', removeLogo: 'Remove logo', logoHelp: 'Your logo stays on this device. Adding one automatically uses stronger scan protection.', convertRoman: 'Convert Roman Urdu to Urdu', convertNote: 'This changes Urdu sounds written in English letters into Urdu script; it does not translate English meaning.', convertBusy: 'Converting…', convertDone: 'Converted to Urdu script.', convertChanged: 'The text changed while conversion was running. Try again.', convertError: 'Conversion failed. Check your connection and try again.', convertNoRoman: 'Enter Roman Urdu first, then choose convert.', privacy: 'Your QR content and logo stay on this device. If you type Urdu with English letters, the privacy policy explains how word suggestions work.', downloadPng: 'Download PNG', downloadSvg: 'Download SVG', copyImage: 'Copy image', share: 'Share' },
        ur: { reset: 'ری سیٹ', back: 'رائٹ اردو پر واپس جائیں', encodeQuestion: 'آپ کا QR کوڈ کیا کھولے یا دکھائے؟', design: 'ڈیزائن', qrColour: 'QR رنگ', background: 'پس منظر', designHelp: 'آسان اسکین کے لیے گہرا QR رنگ، ہلکا پس منظر اور کوڈ کے گرد صاف جگہ رکھیں۔', recommendedColors: 'تجویز کردہ رنگ استعمال کریں', centreLogo: 'مرکزی لوگو', optional: 'اختیاری', chooseLogo: 'PNG، JPG یا WebP منتخب کریں', removeLogo: 'لوگو ہٹائیں', logoHelp: 'آپ کا لوگو اسی آلے پر رہتا ہے۔ لوگو شامل کرنے پر اسکین کی مضبوط حفاظت خود منتخب ہوتی ہے۔', convertRoman: 'رومن اردو کو اردو میں تبدیل کریں', convertNote: 'یہ انگریزی حروف میں لکھی اردو آوازوں کو اردو رسم الخط میں بدلتا ہے؛ انگریزی معنی کا ترجمہ نہیں کرتا۔', convertBusy: 'تبدیلی جاری ہے…', convertDone: 'متن اردو رسم الخط میں تبدیل ہو گیا۔', convertChanged: 'تبدیلی کے دوران متن بدل گیا۔ دوبارہ کوشش کریں۔', convertError: 'تبدیلی ناکام رہی۔ کنکشن دیکھ کر دوبارہ کوشش کریں۔', convertNoRoman: 'پہلے رومن اردو لکھیں، پھر تبدیلی منتخب کریں۔', privacy: 'آپ کی QR تفصیلات اور لوگو اسی آلے پر رہتے ہیں۔ انگریزی حروف سے اردو لکھنے پر رازداری کی پالیسی متبادل الفاظ کے طریقے کی وضاحت کرتی ہے۔', downloadPng: 'PNG ڈاؤن لوڈ کریں', downloadSvg: 'SVG ڈاؤن لوڈ کریں', copyImage: 'تصویر کاپی کریں', share: 'شیئر کریں' }
    };
    ...
    function renderHealth(validation) {
        ...
        health.textContent = validation.valid && !messages.length ? 'Ready to scan' : messages.join(' ');
    }
