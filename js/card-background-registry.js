(function (root, factory) {
    ...
    var backgrounds = [
        ...
        record({ id: 'soft-sunrise-garden', name: 'Soft Sunrise Garden', nameUr: 'صبح کا نرم گلزار', category: 'nature', src: '/assets/card-studio/backgrounds/soft-sunrise-garden.svg', textColor: '#344b42', overlayColor: '#fff6df', overlayOpacity: 0.04, safeArea: { top: 0.2, right: 0.14, bottom: 0.22, left: 0.14 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['morning', 'dua', 'reflection', 'greeting'] }),
        record({ id: 'window-light-tea', name: 'Window Light & Tea', nameUr: 'کھڑکی کی روشنی', category: 'nature', src: '/assets/card-studio/backgrounds/window-light-tea.svg', textColor: '#4b3a2d', overlayColor: '#fff8e9', overlayOpacity: 0.04, safeArea: { top: 0.22, right: 0.16, bottom: 0.23, left: 0.16 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['morning', 'family', 'reflection', 'greeting'] }),
        record({ id: 'quiet-moon-sky', name: 'Quiet Moon Sky', nameUr: 'پرسکون چاندنی رات', category: 'nature', src: '/assets/card-studio/backgrounds/quiet-moon-sky.svg', textColor: '#fff4d4', overlayColor: '#071426', overlayOpacity: 0.08, safeArea: { top: 0.24, right: 0.14, bottom: 0.23, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['night', 'dua', 'reflection', 'poetry'] }),
        record({ id: 'rainy-window-reflection', name: 'Rainy Window Reflection', nameUr: 'بارش بھری کھڑکی', category: 'modern', src: '/assets/card-studio/backgrounds/rainy-window-reflection.svg', textColor: '#fff8e8', overlayColor: '#102332', overlayOpacity: 0.2, safeArea: { top: 0.18, right: 0.17, bottom: 0.2, left: 0.17 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['night', 'reflection', 'poetry'] }),
        record({ id: 'jumma-ivory-geometry', name: 'Jumma Ivory Geometry', nameUr: 'جمعہ عاجی نقش', category: 'classic', src: '/assets/card-studio/backgrounds/jumma-ivory-geometry.svg', textColor: '#214f40', overlayColor: '#fffaf0', overlayOpacity: 0, safeArea: { top: 0.23, right: 0.14, bottom: 0.23, left: 0.14 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['jumma', 'dua', 'reflection', 'greeting'] }),
        record({ id: 'jumma-midnight-silhouette', name: 'Jumma Midnight Silhouette', nameUr: 'جمعہ کی ماہتابی رات', category: 'classic', src: '/assets/card-studio/backgrounds/jumma-midnight-silhouette.svg', textColor: '#fff0ba', overlayColor: '#07151f', overlayOpacity: 0.08, safeArea: { top: 0.2, right: 0.14, bottom: 0.27, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['jumma', 'dua', 'night', 'reflection'] }),
        record({ id: 'emerald-prayer-light', name: 'Emerald Prayer Light', nameUr: 'زمردی دعائیہ روشنی', category: 'classic', src: '/assets/card-studio/backgrounds/emerald-prayer-light.svg', textColor: '#fff2c7', overlayColor: '#063c2f', overlayOpacity: 0.06, safeArea: { top: 0.22, right: 0.15, bottom: 0.22, left: 0.15 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['dua', 'jumma', 'reflection', 'greeting'] }),
        record({ id: 'warm-paper-reflection', name: 'Warm Paper Reflection', nameUr: 'گرم کاغذی خیال', category: 'poetry', src: '/assets/card-studio/backgrounds/warm-paper-reflection.svg', textColor: '#493927', overlayColor: '#fff7e6', overlayOpacity: 0.03, safeArea: { top: 0.22, right: 0.15, bottom: 0.22, left: 0.15 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['reflection', 'dua', 'poetry', 'family'] }),
        record({ id: 'minimal-cream-poetry', name: 'Minimal Cream Poetry', nameUr: 'سادہ عاجی شاعری', category: 'poetry', src: '/assets/card-studio/backgrounds/minimal-cream-poetry.svg', textColor: '#3c3324', overlayColor: '#fffaf0', overlayOpacity: 0, safeArea: { top: 0.27, right: 0.14, bottom: 0.27, left: 0.14 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['poetry', 'reflection', 'quote', 'self-respect'] }),
        record({ id: 'ink-moon-poetry', name: 'Ink & Moon Poetry', nameUr: 'روشنائی و ماہتاب', category: 'poetry', src: '/assets/card-studio/backgrounds/ink-moon-poetry.svg', textColor: '#2c2a24', overlayColor: '#f4f1e8', overlayOpacity: 0.05, safeArea: { top: 0.22, right: 0.16, bottom: 0.24, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['poetry', 'night', 'reflection'] }),
        record({ id: 'rose-mist-affection', name: 'Rose Mist Affection', nameUr: 'گلابی دھند محبت', category: 'love', src: '/assets/card-studio/backgrounds/rose-mist-affection.svg', textColor: '#5a2f36', overlayColor: '#fffaf9', overlayOpacity: 0, safeArea: { top: 0.14, right: 0.14, bottom: 0.14, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['love', 'family', 'greeting'] }),
        record({ id: 'quiet-blue-distance', name: 'Quiet Blue Distance', nameUr: 'خاموش نیلا فاصلہ', category: 'nature', src: '/assets/card-studio/backgrounds/quiet-blue-distance.svg', textColor: '#f2f6fa', overlayColor: '#152433', overlayOpacity: 0.15, safeArea: { top: 0.2, right: 0.14, bottom: 0.3, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['poetry', 'reflection', 'night'] }),
        record({ id: 'self-respect-black-sand', name: 'Self-Respect Black & Sand', nameUr: 'خودداری سیاہ و ریتیلا', category: 'modern', src: '/assets/card-studio/backgrounds/self-respect-black-sand.svg', textColor: '#f1e2bd', overlayColor: '#000000', overlayOpacity: 0.03, safeArea: { top: 0.16, right: 0.16, bottom: 0.16, left: 0.16 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['self-respect', 'reflection', 'quote'] }),
        record({ id: 'friendship-bright-modern', name: 'Friendship Bright Modern', nameUr: 'دوستی روشن و جدید', category: 'modern', src: '/assets/card-studio/backgrounds/friendship-bright-modern.svg', textColor: '#3a2c1f', overlayColor: '#fffaf0', overlayOpacity: 0, safeArea: { top: 0.19, right: 0.14, bottom: 0.24, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['friendship', 'greeting', 'social'] }),
        record({ id: 'family-warm-interior', name: 'Family Warm Interior', nameUr: 'گھر کی گرم فضا', category: 'nature', src: '/assets/card-studio/backgrounds/family-warm-interior.svg', textColor: '#4a3620', overlayColor: '#fff6e2', overlayOpacity: 0.03, safeArea: { top: 0.24, right: 0.13, bottom: 0.18, left: 0.13 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['family', 'friendship', 'reflection'] }),
        record({ id: 'ajrak-modern-frame', name: 'Ajrak Modern Frame', nameUr: 'اجرک جدید فریم', category: 'pakistan', src: '/assets/card-studio/backgrounds/ajrak-modern-frame.svg', textColor: '#fdf6e3', overlayColor: '#12203a', overlayOpacity: 0.06, safeArea: { top: 0.2, right: 0.14, bottom: 0.2, left: 0.14 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['pakistan', 'quote', 'poetry'] }),
        record({ id: 'truck-art-modern-bloom', name: 'Truck Art Modern Bloom', nameUr: 'ٹرک آرٹ جدید بہار', category: 'truck-art', src: '/assets/card-studio/backgrounds/truck-art-modern-bloom.svg', textColor: '#17384a', overlayColor: '#eafffb', overlayOpacity: 0.05, safeArea: { top: 0.2, right: 0.16, bottom: 0.2, left: 0.16 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['social', 'greeting', 'quote'] }),
        record({ id: 'ramadan-lantern-night', name: 'Ramadan Lantern Night', nameUr: 'رمضان کی راتیں', category: 'classic', src: '/assets/card-studio/backgrounds/ramadan-lantern-night.svg', textColor: '#fff3d2', overlayColor: '#0a0f24', overlayOpacity: 0.1, safeArea: { top: 0.22, right: 0.15, bottom: 0.24, left: 0.15 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['ramadan', 'dua', 'night', 'reflection'] }),
        record({ id: 'eid-morning-gold', name: 'Eid Morning Gold', nameUr: 'عید کی سنہری صبح', category: 'classic', src: '/assets/card-studio/backgrounds/eid-morning-gold.svg', textColor: '#2f4a3a', overlayColor: '#fffaf0', overlayOpacity: 0.02, safeArea: { top: 0.2, right: 0.14, bottom: 0.2, left: 0.14 }, textCapacity: 'long', preferredAlign: 'center', goodFor: ['eid', 'greeting', 'family'] }),
        record({ id: 'pakistan-green-heritage', name: 'Pakistan Green Heritage', nameUr: 'پاکستان سبز ورثہ', category: 'pakistan', src: '/assets/card-studio/backgrounds/pakistan-green-heritage.svg', textColor: '#fdf8e8', overlayColor: '#0c2e22', overlayOpacity: 0.08, safeArea: { top: 0.2, right: 0.15, bottom: 0.2, left: 0.15 }, textCapacity: 'medium', preferredAlign: 'center', goodFor: ['pakistan', 'heritage', 'quote'] })
    ];
