(function () {
    ...
    function bindControls() {
        ...
        root.querySelector('[data-card-action="back"]').addEventListener('click', function () { window.location.href = 'index.html'; });
