(function () {
    ...
    function initialiseTransliteration() {
        ...
        function ready() {
            ...
            try {
                ...
                control.makeTransliteratable(['cardText']);
                finished = true;
    ...
    function initialise() {
        ...
        bindControls(); syncControls(); restoreAsset(); requestRender(); initialiseTransliteration();
        if (!incoming && !saved) {
            setStatus(t('privacy'));
