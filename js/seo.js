    ...
    if (!document.head.querySelector('script[data-write-urdu-schema]')) {
        ...
        if (hasSchema('WebApplication')) {
            ...
            graph.push({
                ...
                applicationCategory: page.id === 'urdu-typing-practice' ? 'EducationalApplication' : page.id === 'urdu-card-studio' ? 'DesignApplication' : page.id === 'urdu-editor' || page.id === 'home' ? 'WritingApplication' : 'UtilitiesApplication',
                operatingSystem: 'Any',
