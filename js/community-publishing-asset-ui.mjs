  ...
  const node = openDialog(`
    <form class="wu-community-form" data-wu-community-form>
      <div class="wu-community-hero">
        ...
        <h2 class="wu-community-hero-urdu" lang="ur" dir="rtl">اپنی تخلیق شائع کریں</h2>
        <p class="wu-community-hero-en">Submit to Urdu Writers</p>
        <p class="wu-community-hero-copy">Add a short piece of writing to go with this image. Every submission is reviewed before publication.</p>
      </div>
