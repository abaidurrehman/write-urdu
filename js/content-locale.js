(function () {
    ...
    function localizeDocumentation(locale) {
        ...
        sequence('.docs-faq p', [
            'اگر آپ رومن اردو میں سوچتے ہیں تو <a href="/">بنیادی ایڈیٹر</a> منتخب کریں۔ براہِ راست حروف کے لیے <a href="urdu-keyboard.html">اردو کی بورڈ</a>، اور فارمیٹنگ کے لیے <a href="urdu-editor.html">رچ ایڈیٹر</a> منتخب کریں۔',
    ...
    function localizeEditorHelp(locale) {
        ...
        if (pathName() === '/index.html' || pathName() === '/') {
            one('#UsageAlert', '<i class="fas fa-info-circle" aria-hidden="true"></i> رومن اردو لکھیں، مثلاً <em>mera</em>، اور ہر لفظ تبدیل کرنے کے لیے Space دبائیں۔ مطلوبہ متبادل چننے کے لیے Backspace دو بار دبائیں۔', locale);
            one('.card-subtitle', 'آن لائن اردو لکھیں — رومن اردو اور اردو ان پٹ کے درمیان تبدیل کرنے کے لیے Ctrl+G دبائیں', locale);
            one('h3.card-title', 'انگریزی حروف کی مدد سے اردو کیسے لکھیں', locale);
            sequence('.card-text li', [
                'اوپر موجود ایڈیٹر میں رومن اردو کا لفظ لکھیں، مثلاً <em>mera</em>۔',
                'اسے خودکار طور پر اردو رسم الخط میں تبدیل کرنے کے لیے Space دبائیں۔',
                'نتیجہ آپ کی توقع کے مطابق نہ ہو تو Backspace دو بار دبائیں اور کوئی <strong>متبادل</strong> منتخب کریں۔',
                'جب اردو کسی دوسری ایپ میں پیسٹ کرنی ہو تو <strong>متن کاپی کریں</strong> منتخب کریں۔',
                '“میرا خیال ہے” اردو رسم الخط میں لکھنے کے لیے <a href="urdu-alphabet.html" title="اردو حروف تہجی کا رہنما">اردو رسم الخط</a> منتخب کریں، <em>mera khayal hai</em> ٹائپ کریں اور ہر لفظ کے بعد Space دبائیں۔',
                'اسی طریقے سے نام اور مختصر پیغامات لکھیں، پھر شیئر کرنے سے پہلے انہیں دیکھ لیں۔',
                ...
                'کسی اردو کی بورڈ سافٹ ویئر کی ضرورت نہیں؛ سب کچھ آپ کے براؤزر میں چلتا ہے۔',
                'زبان اور رسم الخط کے واضح جوابات کے لیے <a href="urdu-faq.html" title="اردو کے بارے میں اکثر پوچھے گئے سوالات">اردو سوالات</a> پڑھیں۔'
            ], locale);
        ...
        if (pathName() === '/urdu-editor.html') {
            ...
            sequence('.card-text li', [
                ...
                'نتیجہ آپ کی توقع کے مطابق نہ ہو تو Backspace دو بار دبائیں اور کوئی تجویز منتخب کریں۔',
                'فونٹ، سائز، رنگ، ترتیب یا نمایاں انداز بدلنے کے لیے متن منتخب کریں۔',
                'فارمیٹ شدہ متن کاپی کرنے کے لیے ایڈیٹر کا Edit مینو یا اپنا معمول کا کی بورڈ شارٹ کٹ استعمال کریں۔',
                'Word دستاویز، PDF یا PNG تصویر ڈاؤن لوڈ کرنے، یا دستاویز پرنٹ کرنے کے لیے <strong>برآمد کریں</strong> منتخب کریں۔',
                'Word دستاویزات، خطوط اور رپورٹس کے لیے نفیس اردو متن۔',
                'ویب سائٹس اور ویب ایپلی کیشنز کے لیے دائیں سے بائیں HTML مواد۔',
                'اردو مضامین یا بلاگ پوسٹس کے لیے عنوانات، اقتباسات اور متن۔',
                'ای میل، پریزنٹیشن اور سوشل میڈیا کے لیے واضح اور خوب صورت اردو پیغامات۔'
            ], locale);
        ...
        if (pathName() === '/urdu-keyboard.html') {
            ...
            sequence('.card-text li', [
                ...
                'آپ فزیکل کی بورڈ سے بھی لکھ سکتے ہیں۔ Space دبانے پر رومن اردو کے الفاظ تبدیل ہو جاتے ہیں۔',
    ...
    function localizeDynamicEditorTools(locale) {
        ...
        if (!panel) return;
        setAttribute('.editor-productivity', 'aria-label', 'لکھنے کے ٹولز، مسودے اور ایڈیٹر کے اختیارات', locale);
        ...
        one('.editor-productivity [data-save-status]', 'مسودے صرف اسی آلے پر محفوظ ہوتے ہیں', locale);
        ...
        one('.editor-history-empty', 'ابھی کوئی محفوظ مسودہ نہیں۔ کچھ لکھیں تاکہ نیا مسودہ بن جائے۔', locale);
        ...
        if (onboardingKind) {
            ...
            one('[data-onboarding-body]', kind === 'keyboard' ? 'آن اسکرین کی بورڈ سے حرف منتخب کریں یا اپنے فزیکل کی بورڈ سے لکھیں۔ آپ کا کام اسی براؤزر میں محفوظ رہتا ہے۔' : kind === 'rich' ? 'رومن اردو کا لفظ لکھیں اور اسے تبدیل کرنے کے لیے Space دبائیں، پھر عنوانات، فہرست، فونٹ اور ترتیب کے لیے ٹول بار استعمال کریں۔' : 'رومن اردو کا لفظ—مثلاً mera—لکھیں اور اسے اردو رسم الخط میں تبدیل کرنے کے لیے Space دبائیں۔', locale);
            one('[data-onboarding-tip]', kind === 'keyboard' ? 'مشورہ: اردو متن دوسری جگہ پیسٹ کرنے کے لیے متن کاپی کریں۔' : 'مشورہ: ٹولز جلدی تلاش کرنے یا مقامی مسودہ محفوظ کرنے کے لیے شارٹ کٹس کھولیں۔', locale);
        }
    ...
    function localizeGuides(locale) {
        ...
        if (route === '/urdu-editor-features.html') {
            ...
            attributeSequence('.content-article img', 'alt', ['رائٹ اردو کے موجودہ رچ ٹیکسٹ ایڈیٹر کا ٹول بار', 'موجودہ رچ ٹیکسٹ ایڈیٹر میں بولڈ اردو متن', 'موجودہ اردو رچ ٹیکسٹ ایڈیٹر کا فونٹ فیملی مینو', 'موبائل اسکرین پر موزوں اردو رچ ٹیکسٹ ایڈیٹر'], locale);
            one('.card-title', 'رائٹ اردو کی خصوصیات کا ویڈیو رہنما', locale);
        }
    ...
    function localizeReferencePages(locale) {
        ...
        if (route === '/why-write-urdu.html') {
            one('.why-eyebrow', 'ہمارا مقصد', locale);
            one('.why-lede', 'اردو لکھنا وہاں آسان ہونا چاہیے جہاں آپ کے خیالات جنم لیتے ہیں۔ رائٹ اردو مانوس رومن اردو کو قابلِ مطالعہ اردو میں بدلتا ہے، پھر متن سنوارنے، محفوظ کرنے اور شیئر کرنے کے ٹولز فراہم کرتا ہے۔', locale);
            sequence('.why-actions a', ['لکھنا شروع کریں <span aria-hidden="true">←</span>', 'رہنما دیکھیں <span aria-hidden="true">←</span>'], locale);
            one('.why-hero-note', 'زبان یاد، خاندان اور تعلق کو اپنے اندر رکھتی ہے۔ درست ٹولز اسے آگے پہنچانے میں مدد دیتے ہیں۔', locale);
            sequence('.why-section-heading .why-eyebrow, .why-path-heading .why-eyebrow, .why-cta .why-eyebrow', ['اہمیت', 'اپنا آغاز منتخب کریں', 'مسلسل بہتری'], locale);
            one('.why-section-heading h2', 'اعتماد کے ساتھ اردو لکھنے کا آسان راستہ', locale);
            one('.why-section-heading > p:last-child', 'چاہے آپ مختصر پیغام لکھ رہے ہوں یا مکمل دستاویز تیار کر رہے ہوں، تجربہ پُرسکون، مانوس اور اردو کے دائیں سے بائیں بہاؤ کا احترام کرنے والا ہونا چاہیے۔', locale);
            sequence('.why-value-card h3', ['اپنے مانوس الفاظ سے آغاز کریں', 'تحریر کا اختیار اپنے ہاتھ میں رکھیں', 'ایسا کام شیئر کریں جو درست دکھائی دے'], locale);
            sequence('.why-value-card p', ['انگریزی کی بورڈ سے رومن اردو لکھیں اور ہر مکمل لفظ کو اردو رسم الخط میں بدلنے کے لیے Space دبائیں۔', 'مسودے، رموزِ اوقاف، تلاش اور تبدیلی اور فوکس موڈ ضروری کنٹرول قریب رکھتے ہیں، مگر صفحے سے توجہ نہیں ہٹاتے۔', 'جب ترتیب اہم ہو تو تیار اردو دستاویز کو کاپی، پرنٹ یا Word، PDF اور PNG کی صورت میں برآمد کریں۔'], locale);
            one('.why-path-heading h2', 'ہر طرح کی اردو تحریر کے لیے ایک جگہ', locale);
            one('.why-path-heading > p:last-child', 'آج کے کام کے لیے سب سے آسان ٹول منتخب کریں۔ مسودہ بڑھنے پر کسی بھی ایڈیٹر میں منتقل ہو جائیں۔', locale);
            sequence('.why-path-card h3', ['بنیادی ایڈیٹر', 'رچ ٹیکسٹ ایڈیٹر', 'اردو کی بورڈ'], locale);
            sequence('.why-path-card p', ['پیغامات، نوٹس اور روزمرہ تحریر کے لیے تیز رومن اردو تحریر تبدیلی۔', 'اچھی طرح پیش کی جانے والی دستاویزات کے لیے عنوانات، فہرستیں، فونٹس اور ترتیب۔', 'جب آپ رسم الخط جانتے ہوں یا بصری رہنما درکار ہو تو حروف براہِ راست منتخب کریں۔'], locale);
            sequence('.why-path-link', ['بنیادی ایڈیٹر کھولیں <span aria-hidden="true">↖</span>', 'دستاویز فارمیٹ کریں <span aria-hidden="true">↖</span>', 'کی بورڈ کھولیں <span aria-hidden="true">↖</span>'], locale);
            one('.why-cta h2', 'اردو لکھنے کو مزید بہتر بنانے میں ہماری مدد کریں', locale);
            one('.why-cta p:last-child', 'آپ کی واضح رائے درستگی، رسائی اور ان چھوٹی تفصیلات کو بہتر بنانے میں مدد دیتی ہے جو تحریر کو قدرتی بناتی ہیں۔', locale);
            one('.why-cta a', 'رائے شیئر کریں <span aria-hidden="true">←</span>', locale);
        }
