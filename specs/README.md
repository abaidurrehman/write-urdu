...
| `WU-TPL-001` | Urdu Writing Templates | `/urdu-writing-templates` | Implemented core / acceptance pending — 12 AI-free writing starters with Basic Writer/Rich Editor handoff; indexing held for content/SEO acceptance |
