...
| `WU-CARD-CONTENT-001` | Ready-made Urdu Cards Gallery | **Implemented core / acceptance pending** — `/urdu-cards` is public and reuses the shared background registry, Card Studio handoff and real public-share flow |
| `WU-CARD-CONTENT-001A` | Recurring Social Content Library | **Active implementation slice** — first 32-message morning/night/Jumma/reflection batch adds source/rights/context metadata; later content families remain evidence-gated |
| `WU-CARD-GALLERY-001` | Live Urdu Card Gallery / Background-First Rich Studio | **Implemented core / acceptance pending** — `/urdu-card-gallery` is public, shares the background registry and hands exact text/design into Card Studio |
