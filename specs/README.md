...
| `WU-GROWTH-002` | Account Save + Share Entry Points | **Active** — retention/share loop; value-triggered Keep/Share/Publish arbitration is now governed by `WU-PLAT-002H` |
...
| `WU-SHARE-001` | Public Share Pages & Viral Publishing Loop | **Active** — core loop shipped; recipient CTA → destination ready → referred-start continuity is a P0 acceptance dependency of `WU-PLAT-002H` |
