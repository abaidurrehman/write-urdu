...
assert.match(serviceWorker, /write-urdu-shell-v48/, 'PWA cache must refresh for embedded voice, export-discovery, B4 batch and Voice Translator direction assets');
