...
assert.match(serviceWorker, /write-urdu-shell-v49/, 'PWA cache must refresh for Card Studio backgrounds, embedded voice, export-discovery, B4 batch and Voice Translator direction assets');
