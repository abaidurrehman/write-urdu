...
assert.match(serviceWorker, /write-urdu-shell-v51/, 'PWA cache must refresh for Card Studio backgrounds, embedded voice, export-discovery, B4 batch and Voice Translator direction assets');
