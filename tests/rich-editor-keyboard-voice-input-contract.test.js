...
assert.match(serviceWorker, /write-urdu-shell-v51/, 'PWA cache must refresh for Card Studio backgrounds, Rich Editor/Keyboard voice, mobile activation, B4 batch and Voice Translator direction assets');
