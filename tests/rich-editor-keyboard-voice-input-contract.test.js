...
assert.match(serviceWorker, /write-urdu-shell-v48/, 'PWA cache must refresh for Rich Editor/Keyboard voice, mobile activation, B4 batch and Voice Translator direction assets');
