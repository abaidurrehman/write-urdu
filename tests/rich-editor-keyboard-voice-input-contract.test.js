...
assert.match(serviceWorker, /write-urdu-shell-v49/, 'PWA cache must refresh for Card Studio backgrounds, Rich Editor/Keyboard voice, mobile activation, B4 batch and Voice Translator direction assets');
