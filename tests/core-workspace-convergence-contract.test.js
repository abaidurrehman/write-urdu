...
assert.match(serviceWorker, /write-urdu-shell-v49/, 'PWA cache must include the Card Studio collection, desktop export icon, B4 batch runtime and Voice Translator direction update');
