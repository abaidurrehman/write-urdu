...
assert.match(serviceWorker, /write-urdu-shell-v48/, 'PWA generation must remain compatible with the current account-document, B4 batch and Voice Translator direction shell');
