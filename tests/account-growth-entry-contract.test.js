...
assert.match(serviceWorker, /write-urdu-shell-v51/, 'PWA generation must remain compatible with the current account-document, Card Studio collection, B4 batch and Voice Translator direction shell');
