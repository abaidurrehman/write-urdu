...
assert.match(serviceWorker, /write-urdu-shell-v48/, 'PWA shell must include the current account/document UI, export-discovery, B4 batch runtime and Voice Translator direction revision');
