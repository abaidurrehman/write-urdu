...
assert.match(serviceWorker, /write-urdu-shell-v49/, 'PWA shell must include the current account/document UI, Card Studio collection, export-discovery, B4 batch runtime and Voice Translator direction revision');
