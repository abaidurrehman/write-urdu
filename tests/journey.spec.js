...
test('core writing surfaces expose Create & Share as the primary next-step journey', async ({ page }) => {
...
test('Create & Share carries current Urdu into Card Studio and exposes Publish & Share in Step 4', async ({ page }) => {
  ...
  await page.locator('[data-wu-journey-panel] [data-create-card]').click();
