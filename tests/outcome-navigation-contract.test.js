...
assert.match(sw, /write-urdu-shell-v49/, 'PWA cache version must include Card Studio backgrounds, mega-menu nav JS/CSS, B4 batch and Voice Translator direction assets');
