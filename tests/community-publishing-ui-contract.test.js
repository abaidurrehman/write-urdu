...
assert.match(community, /owner\.opened\('community_publish'\)/, 'Opening Community Publish must be measured through the shared owner');
assert.match(community, /owner\.completed\('community_publish'\)/, 'Completed Community Publish must be measured through the shared owner');
