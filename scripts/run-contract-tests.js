...
const tests = [
  ...
  'tests/public-source-crawlability-contract.test.js',
  'tests/static-html-sanity.test.js',
  'tests/static-shell-source-contract.test.js',
  'tests/static-seo-graph-contract.test.js',
  'tests/static-collection-content-contract.test.js',
  ...
  'tests/community-moderation-security-contract.test.js',
  ...
  'tests/card-gallery-slice0-contract.test.js',
  'tests/card-gallery-slice1-contract.test.js',
